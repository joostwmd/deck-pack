...
function createTextMutation(
  shapeId: string,
  mutation: Omit<ShapeMutation, "shapeId">,
): ShapeMutation {
...
function createMarginPlan(
  shapes: SelectedShape[],
  mode: "remove" | "increase" | "decrease",
): ShapeMutation[] {
...
function createVerticalAlignPlan(
  shapes: SelectedShape[],
  alignment: TextVerticalAlignmentMode,
): ShapeMutation[] {
...
function createVerticalAlignCommand(
  id: FormattingActionId,
  alignment: TextVerticalAlignmentMode,
): FormattingCommand {
  return {
...
export const textAutofitShrinkTextCommand = createAutoSizeCommand(
  "text-autofit-shrink-text",
  "shrink-text",
);
export const textAutofitResizeShapeCommand = createAutoSizeCommand(
...
export const textVerticalMiddleCommand = createVerticalAlignCommand(
  "text-vertical-middle",
  "middle",
);
export const textVerticalBottomCommand = createVerticalAlignCommand(
