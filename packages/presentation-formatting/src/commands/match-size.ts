import type { FormattingActionId, FormattingCommand, MatchSizeMode, ShapeSelection } from "../types";
import { composePolicies, evaluateApplicability, minShapes, supportsBoundsMutation, supportsResize } from "../policies";
import {
  applyVisualHeight,
  applyVisualWidth,
