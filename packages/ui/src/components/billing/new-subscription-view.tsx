...
import type { OrganizationOption, PlanOption } from "./types";
          ...
          {props.loadingOptions ? (
            ...
            <form onSubmit={props.onSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                {noOrgs ? (
                  <p className="text-muted-foreground text-xs">Create an organization first.</p>
                ) : null}
              </div>
              ...
              <div className="flex gap-2 pt-2">
                <Button type="submit" disabled={props.submitting || noOrgs || noPlans}>
                  {props.submitting ? "Creating…" : "Create subscription"}
                </Button>
                <Button type="button" variant="outline" render={<Link to="/plans/subscriptions" />}>
                  Cancel
                </Button>
              </div>
            </form>
