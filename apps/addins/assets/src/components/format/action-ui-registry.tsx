...
export const formatActionDefinitions: FormatActionDefinition[] = [
  ...
  {
    id: "gap-increase-horizontal",
    label: "Increase horizontal gap",
    section: "spacing",
    domain: "shapes",
  },
  {
    id: "gap-decrease-horizontal",
    label: "Decrease horizontal gap",
    section: "spacing",
    domain: "shapes",
  },
  {
    id: "gap-increase-vertical",
    label: "Increase vertical gap",
    section: "spacing",
    domain: "shapes",
  },
  {
    id: "gap-decrease-vertical",
    label: "Decrease vertical gap",
    section: "spacing",
    domain: "shapes",
  },
  {
    id: "gap-remove-horizontal",
    label: "Remove horizontal gap",
    section: "spacing",
    domain: "shapes",
  },
  ...
  {
    id: "text-autofit-shrink-text",
    label: "Shrink text on overflow",
    section: "text-autofit",
    domain: "text",
  },
  {
    id: "text-autofit-resize-shape",
    label: "Resize shape to fit text",
    section: "text-autofit",
    domain: "text",
  },
  {
    id: "text-margin-remove",
    label: "Remove text margins",
    section: "text-margins",
    domain: "text",
  },
  {
    id: "text-margin-increase",
    label: "Increase text margins",
    section: "text-margins",
    domain: "text",
  },
  {
    id: "text-margin-decrease",
    label: "Decrease text margins",
    section: "text-margins",
    domain: "text",
  },
  ...
  {
    id: "text-vertical-top",
    label: "Align text top",
    section: "text-vertical-align",
    domain: "text",
  },
  {
    id: "text-vertical-middle",
    label: "Align text middle",
    section: "text-vertical-align",
    domain: "text",
  },
  {
    id: "text-vertical-bottom",
  ...
  },
  {
    ...
    section: "text-swap",
    domain: "text",
    description: "Swaps plain text between two objects",
  },
];
