...
export function getDefaultCommandParams(commandId: FormattingActionId): unknown {
  switch (commandId) {
    ...
    case "gap-decrease-horizontal":
      return { mode: commandId.includes("increase") ? "increase" : "decrease", direction: "horizontal", value: 12 };
    case "gap-increase-vertical":
    case "gap-decrease-vertical":
      return { mode: commandId.includes("increase") ? "increase" : "decrease", direction: "vertical", value: 12 };
    case "set-bounds":
      return {};
    default:
      return undefined;
