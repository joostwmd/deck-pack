...
export function OrgUsageDashboardSection() {
  ...
  const bySeatQuery = useQuery(trpc.usage.bySeat.queryOptions(periodInput));

  const memberQuery = useQuery({
    ...trpc.usage.member.queryOptions({
      ...periodInput,
      userId: selectedSeat?.userId ?? "",
    }),
    enabled: Boolean(selectedSeat?.userId),
  });
